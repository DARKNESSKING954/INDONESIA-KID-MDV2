...
const indonesiakidCommand = require('./commands/indonesiakid');
...
global.channelLink = "https://whatsapp.com/channel/0029VbAvE5e6buMSYIiyS20t";
global.ytch = "IndonesiaKid";
        ...
        switch (true) {
           ...
           case userMessage.startsWith('.sinhalasub') || userMessage.startsWith('.movie'):
            ...
            case userMessage.startsWith('.instagram') || userMessage.startsWith('.insta') || userMessage.startsWith('.ig'):
                ...
                break;
                case userMessage.startsWith('.indonesiakid') ||     userMessage.startsWith('.Indonesiakid') ||                userMessage.startsWith('.indonesiakidxmdchatgpt') ||           userMessage.startsWith('.indonesiakidmddeepseek') ||
                 userMessage.startsWith('.indonesiakid') ||

                 userMessage.startsWith('.indomd'):

                await indoKidCommand(sock, chatId, message);
                ...
                await sock.sendMessage(id, {
                    ...
                    contextInfo: {
                        ...
                        forwardedNewsletterMessageInfo: {
                            ...
                            newsletterName: 'INDONESIAKID MD',
                            serverMessageId: -1
                        }
                    }
                });
